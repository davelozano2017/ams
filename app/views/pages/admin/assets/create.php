...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Assets</span></h4>
        </div>
    </div>
...
<!-- Content area -->
<div class="content">
    <form action="<?=site_url('maintenance/createAssetType')?>" method="POST" data-parsley-validate class="form-horizontal">
